  ...
  <div class="tx-page">
    ...
    <div class="tx-layout">
      ...
      <template v-else>
        ...
        >
          <div class="page-eyebrow">Block <router-link :to="EXPLORER + 'b/' + $route.params.id" class="eyebrow-link">#{{ $route.params.id }}</router-link></div>
...
export default {
  ...
  data() {
    return { block: {}, tx: {}, exists: false, showRaw: false, EXPLORER: Config.EXPLORER }
  },
...
.eyebrow-link { color: #449dd1; text-decoration: none; font-weight: 800; }
.eyebrow-link:hover { color: #192bc2; }
...
.raw-btn {
  ...
  font-weight: 500; color: #5878a0; cursor: pointer;
